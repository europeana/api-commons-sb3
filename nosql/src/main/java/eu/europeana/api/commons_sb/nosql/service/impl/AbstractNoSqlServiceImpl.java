package eu.europeana.api.commons_sb.nosql.service.impl;
...
import eu.europeana.api.commons_sb.nosql.dao.NosqlDao;
import eu.europeana.api.commons_sb.nosql.entity.NoSqlEntity;
import eu.europeana.api.commons_sb.nosql.service.AbstractNoSqlService;
...
public abstract class AbstractNoSqlServiceImpl<E extends NoSqlEntity, T extends Serializable> implements AbstractNoSqlService<E, T> {
	...
	/*
	 * (non-Javadoc)
	 * @see eu.europeana.api.commons_sb.nosql.service.AbstractNoSqlService#remove(java.io.Serializable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see eu.europeana.api.commons_sb.nosql.service.AbstractNoSqlService#findByID(java.io.Serializable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see eu.europeana.api.commons_sb.nosql.service.AbstractNoSqlService#findAll()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see eu.europeana.api.commons_sb.nosql.service.AbstractNoSqlService#store(eu.europeana.api.commons_sb.nosql.entity.NoSqlEntity)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see eu.europeana.api.commons_sb.nosql.service.AbstractNoSqlService#exists(java.io.Serializable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see eu.europeana.api.commons_sb.nosql.service.AbstractNoSqlService#count()
	 */
	@Override
	public long count() {
		return dao.count();
