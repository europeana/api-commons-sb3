package eu.europeana.api.commons_sb.auth;

import eu.europeana.api.commons_sb.auth.apikey.ApikeyBasedAuthentication;
import eu.europeana.api.commons_sb.auth.service.AuthenticationService;
import eu.europeana.api.commons_sb.auth.token.LongLastingTokenAuthentication;
import eu.europeana.api.commons_sb.auth.token.StaticTokenAuthentication;
