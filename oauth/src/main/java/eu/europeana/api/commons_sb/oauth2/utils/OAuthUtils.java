package eu.europeana.api.commons_sb.oauth2.utils;

import eu.europeana.api.commons_sb.exception.ApiKeyExtractionException;
import eu.europeana.api.commons_sb.exception.AuthorizationExtractionException;
import eu.europeana.api.commons_sb.oauth2.model.impl.EuropeanaApiCredentials;
import eu.europeana.api.commons_sb.oauth2.model.impl.EuropeanaAuthenticationToken;
...
public class OAuthUtils {
    ...
    public static String extractApiKey(HttpServletRequest request)
        ...
        String wskeyParam = request.getParameter(PARAM_WSKEY);
        // use case 1
        if (wskeyParam != null)
            return wskeyParam;
    ...
    /**
     * This method adopts KeyCloak token from HTTP request
     *
