package eu.europeana.api.commons_sb.oauth2.service.impl;

import com.fasterxml.jackson.databind.ObjectMapper;
import eu.europeana.api.commons_sb.auth.AuthenticationHandler;
import eu.europeana.api.commons_sb.definitions.oauth.KeyValidationError;
...
import static eu.europeana.api.commons_sb.oauth2.utils.OAuthUtils.PARAM_CLIENT_ID;
import static eu.europeana.api.commons_sb.oauth2.utils.OAuthUtils.X_FORWARDED_PROTO;
import static eu.europeana.api.commons_sb.oauth2.utils.OAuthUtils.HTTPS;
import static eu.europeana.api.commons_sb.oauth2.utils.OAuthUtils.K8S_FQDN_SUFFIX;

/**
 * The entry point into the database of clients.
 */
@Service(EuropeanaBeanNames.CLIENT_DETAILS_SERVICE)
