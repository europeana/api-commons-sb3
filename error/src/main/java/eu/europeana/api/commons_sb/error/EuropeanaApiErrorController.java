...
import static eu.europeana.api.commons_sb.error.EuropeanaErrorConstants.*;
...
public class EuropeanaApiErrorController extends AbstractErrorController {
    ...
    @Value("${spring.web.error.include-message:always}")
    ...
    @Value("${spring.web.error.include-exception:true}")
    ...
    public Map<String, Object> error(HttpServletRequest request) {
        ...
        if (ErrorProperties.IncludeAttribute.ON_PARAM.equals(includeStacktrace) && this.getTraceParameter(request)) {
